...
export async function POST(req) {
  try {
    ...
    const user = await sql`
      INSERT INTO users (id, email, password, first, last, initials, instrument, phone, role, sub_type, is_admin, tags, theme, musician_id)
      VALUES (${b.id}, ${b.email}, ${b.password}, ${b.first}, ${b.last}, ${b.initials}, ${b.instrument}, ${b.phone}, ${b.role}, ${b.subType}, ${b.isAdmin}, ${JSON.stringify(b.tags||[])}, ${b.theme||'dark'}, ${b.musicianId||null})
